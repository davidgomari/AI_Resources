...
| Stanford: Introduction to Statistics | Coursera, Stanford | Stanford's "Introduction to Statistics" teaches you statistical thinking concepts that are essential for learning from data and communicating insights. By the end of the course, you will be able to perform exploratory data analysis, understand key principles of sampling, and select appropriate tests of significance for multiple contexts. You will gain the foundational skills that prepare you to pursue more advanced topics in statistical thinking and machine learning. | [link](https://www.coursera.org/learn/stanford-statistics) | Neural Networks for Machine Learning — Geoffrey Hinton (deleted from coursera) | Coursera | ~ | [youtube](https://www.youtube.com/playlist?list=PLLssT5z_DsK_gyrQ_biidwvPYCRNGI3iv), [dl links](https://www.cs.toronto.edu/~hinton/coursera_lectures.html) |
